...
class TestDataset:
    ...
    def test_load_json_transcripts_list(self, temp_dataset_dir, sample_audio_files):
        ...
        data = [
            ...
            {"audio": "audio/001.wav", "text": "JSONテスト2", "speaker": "speaker_002"},
        ]
    ...
    def test_duration_filtering(self, temp_dataset_dir):
        ...
        dataset = TsukuyomiDataset(
            temp_dataset_dir, min_duration=0.5, max_duration=15.0
        )
    ...
    def test_validation_split(self, temp_dataset_dir, sample_audio_files):
        ...
        train_dataset = TsukuyomiDataset(
            temp_dataset_dir, validation_split=0.5, is_validation=False, random_seed=42
        )

        # Create validation dataset
        val_dataset = TsukuyomiDataset(
            temp_dataset_dir, validation_split=0.5, is_validation=True, random_seed=42
        )
...
class TestSpeakerMetadata:
    ...
    def test_from_dict_full(self):
        ...
        data = {
            ...
            "age_range": "20-30",
            "dialect": "kansai",
            "voice_characteristics": {"pitch": "high", "rate": "fast"},
        }
    ...
    def test_to_dict(self):
        ...
        metadata = SpeakerMetadata(
            speaker_id="003", name="変換テスト", gender="male", dialect="tokyo"
        )
