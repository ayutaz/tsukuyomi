...
class TestXPhoneBERTEncoder:
        ...
        with patch("src.models.xphonebert.AutoModel") as mock_auto_model:
            with patch("src.models.xphonebert.AutoTokenizer") as mock_auto_tokenizer:
                ...
                encoder = XPhoneBERTEncoder(
                    model_name="vinai/xphonebert-base", device="cpu", use_bf16=False
                )
    ...
    def test_extract_frame_level_features_no_duration(
        self, encoder: XPhoneBERTEncoder
    ) -> None:
    ...
    def test_extract_frame_level_features_with_duration(
        self, encoder: XPhoneBERTEncoder
    ) -> None:
    ...
    def test_device_and_precision_settings(
        ...
        with patch("src.models.xphonebert.AutoModel") as mock_auto_model:
            with patch("src.models.xphonebert.AutoTokenizer") as mock_auto_tokenizer:
                ...
                encoder = XPhoneBERTEncoder(device=device, use_bf16=use_bf16)
