...
class TestConformerBlock:
    ...
    def test_forward_pass(self, conformer_block: ConformerBlock, config: AcousticModelConfig) -> None:
    ...
    def test_gradient_flow(self, conformer_block: ConformerBlock, config: AcousticModelConfig) -> None:
...
class TestAcousticModel:
    ...
    def test_initialization(self, acoustic_model: AcousticModel, config: AcousticModelConfig) -> None:
    ...
    def test_bf16_support(self, config: AcousticModelConfig) -> None:
        ...
        phoneme_features = torch.randn(
            batch_size, seq_len, phoneme_dim, 
