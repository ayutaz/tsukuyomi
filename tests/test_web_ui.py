...
class TestSynthesisPage:
    ...
    def test_synthesis_page_render(self, mock_st, mock_button, mock_text_area):
        ...
        with patch('src.tools.web_ui.pages.synthesis.load_tts_model', return_value=mock_tts):
...
class TestVoiceMorphingPage:
    ...
    def test_voice_morphing_render(self, mock_st, mock_button, mock_text_area):
        ...
        with patch('src.tools.web_ui.pages.voice_morphing.load_tts_model', return_value=mock_tts):
...
class TestVoiceCloningPage:
    ...
    def test_voice_cloning_render(self, mock_st, mock_button, mock_text_area, mock_uploader):
        ...
        with patch('src.tools.web_ui.pages.voice_cloning.load_tts_model', return_value=mock_tts):
...
class TestBatchProcessingPage:
    ...
    def test_batch_processing_render(self, mock_st, mock_button, mock_uploader):
        ...
        with patch('src.tools.web_ui.pages.batch_processing.load_tts_model', return_value=mock_tts):
...
class TestModelManagementPage:
    ...
    def test_model_management_render(self, mock_st, mock_button, mock_selectbox):
        ...
        with patch('src.tools.web_ui.pages.model_management.get_available_models', return_value=["model1", "model2"]):
