...
class TestEvaluationMetrics:
    ...
    def test_comprehensive_evaluator(self, sample_audio):
        ...
        with patch.object(MelCepstralDistortion, 'calculate', return_value=3.5):
            with patch.object(PitchEvaluator, 'evaluate', return_value={'pitch_correlation': 0.9}):
                with patch.object(SpeakerSimilarity, 'calculate_similarity', return_value=0.85):
...
class TestBenchmark:
    ...
    def test_performance_benchmark(self, mock_cuda, benchmark_config, mock_model, temp_dir):
