...
class TestMOSEvaluator:
    ...
    def test_add_evaluation(self):
        ...
        evaluator.add_evaluation(
            ...
            metadata={"speaker": "speaker_001", "emotion": "neutral"},
        )
    ...
    def test_calculate_mos(self):
        ...
        for i in range(5):
            evaluator.add_evaluation(
                audio_id="test_001", score=4.0 + i * 0.2, listener_id=f"listener_{i}"
            )
...
class TestMOSCollector:
    ...
    def test_collector_creation(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            collector = MOSCollector(audio_dir=tmpdir, output_file="mos_results.json")
    ...
    def test_collect_score(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            collector.collect_score(
                audio_file=audio_file, score=4.2, listener_id="test_listener"
            )
...
class TestEvaluationConfig:
    ...
    def test_custom_config(self):
        ...
        config = EvaluationConfig(
            scale_min=0, scale_max=10, scale_step=1, require_listener_id=False
        )
