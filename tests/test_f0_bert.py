...
class TestContinuousF0Encoder:
    ...
    def test_normalization(self, encoder):
        ...
        f0_values = torch.tensor([[30.0, 150.0, 1000.0]])  # Below min, normal, above max
    ...
    def test_sinusoidal_encoding(self, encoder):
        ...
        assert encoder.f0_positional_encoding.shape == (1, 256, 768)  # (1, f0_bins, hidden_size)
...
class TestF0BERT:
    ...
    def test_frame_expansion(self, model):
        ...
        frame_lengths = torch.tensor([
            [5, 10, 8, 12, 6, 9, 7, 11, 8, 10],
            [6, 9, 10, 8, 7, 11, 9, 8, 10, 7]
        ])  # Frames per phoneme
