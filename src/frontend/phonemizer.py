...
class MultilingualPhonemizer:
    ...
    def phonemize(
        ...
        if language == Language.JAPANESE:
            ...
            results = [self._phonemize_general(t, language.value, return_tokens) for t in texts]
            
        if single_input:
            return results[0]
        return results
        
    def _phonemize_japanese(self, text: str, return_tokens: bool = False) -> str | tuple[str, list[str]]:
    ...
    def _phonemize_english(self, text: str, return_tokens: bool = False) -> str | tuple[str, list[str]]:
    ...
    def _phonemize_chinese(self, text: str, return_tokens: bool = False) -> str | tuple[str, list[str]]:
    ...
    def _phonemize_general(self, text: str, language: str, return_tokens: bool = False) -> str | tuple[str, list[str]]:
    ...
    def _katakana_to_phonemes(self, katakana: str) -> str:
        ...
        katakana_to_ipa = {
            ...
            "タ": "ta", "チ": "t͡ɕi", "ツ": "t͡sɯ", "テ": "te", "ト": "to",
            "ダ": "da", "ヂ": "d͡ʑi", "ヅ": "d͡zɯ", "デ": "de", "ド": "do",
    ...
    def _fallback_phonemize(self, text: str, return_tokens: bool = False) -> str | tuple[str, list[str]]:
