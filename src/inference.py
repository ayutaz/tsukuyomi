...
class TsukuyomiTTS:
    ...
    def _enable_h100_optimizations(self):
        ...
        if torch.cuda.is_available():
            ...
            if "H100" in device_name:
                ...
                warnings.warn(f"H100 optimizations requested but device is {device_name}")
    ...
    def synthesize(
        ...
        # Encode phonemes
        phoneme_embeddings = self.phoneme_encoder(phoneme_sequences, return_pooled=False)[0]
    ...
    def export_onnx(
        ...
        warnings.warn("ONNX export is simplified and may need additional work for production")
        
        print(f"Models exported to {output_dir}")
    
    def benchmark(self, text: str = "これは音声合成のベンチマークテストです。", n_runs: int = 10):
        """
