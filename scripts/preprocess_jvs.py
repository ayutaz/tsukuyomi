...
def main():
    ...
    # 転写テキストの読み込み
    transcript_path = input_dir / "jvs_ver1" / "prompt-lab" / args.subset / "transcripts_utf8.txt"
    ...
    # 話者ディレクトリの取得
    speaker_dirs = sorted([
        d for d in (input_dir / "jvs_ver1").iterdir()
    ...
    for split_name, split_data in [
        ...
        with open(filelist_path, 'w', encoding='utf-8') as f:
            for item in split_data:
                f.write(f"{item['audio_path']}|{item['normalized_text']}|{item['speaker_id']}\n")
